...
use crate::repository::{BookmarkRepository, BookmarkRepositoryError};
...
impl BookmarkUseCase {
    pub async fn list_bookmark(&self) -> Result<Vec<BookmarkEntity>, BookmarkUseCaseError> {
        ...
        let bookmarks = response
            ...
            .collect::<Result<Vec<BookmarkEntity>, http_api_core::error::Error>>()?;
...
mod tests {
    ...
    use super::*;
    use crate::repository::BookmarkRepositoryStub;
