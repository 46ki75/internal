...
impl TypingRepository for TypingRepositoryImpl {
    async fn typing_list(
        ...
        lambda_http::tracing::debug!("Sending request to DynamoDB: typing_list");
    ...
    async fn upsert_typing(
        ...
        lambda_http::tracing::debug!("Sending request to DynamoDB: upsert_typing");
    ...
    async fn delete_typing(
        ...
        lambda_http::tracing::debug!("Sending request to DynamoDB: delete_typing");
        let _response = request
            .send()
            .await
            .map_err(|e| crate::error::Error::DynamoDb(e.to_string()))?;
