...
async fn main() {
    ...
    let mut bootstrap_content = std::fs::File::open("../../target/lambda/cron-routine/bootstrap")
    ...
    let request = client
        ...
        .function_name(format!("{environment}-46ki75-lambda-function-routine"))
        .publish(true)
        .zip_file(zip_blob);
    ...
    println!("Deployed cron-routine service!");
}
